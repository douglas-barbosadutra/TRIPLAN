...
<body>
	...
	<br />
		...
		%>
		<form method="POST" action="/JspApp/UserServlet?richiesta=City mj">
		<input type="hidden" name="idcity" value="<%=city.getIdCity()%>" />
		<input type="radio" name="name_city" value="<%=city.getName_City()%>" />
