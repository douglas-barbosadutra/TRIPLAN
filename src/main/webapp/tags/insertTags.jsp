...
<body>
	...
	<br>
	<br>
	<form method="POST" action="/Tags/insert">

	
		<br>
		Nome Tag: <input type="text" size="40" maxlength="40" name="nametag"/>
		<br>
		<br>
		Nome Attrazione: <input type="text" size="40" maxlength="40" name="nameplacetag"/>
		<br>
		<br>
		<br>
		<br>
