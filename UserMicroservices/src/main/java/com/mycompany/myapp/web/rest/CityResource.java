...
public class CityResource {
    ...
    @GetMapping("/cities")
    @Timed
    public ResponseEntity<List<CityDTO>> getAllCities(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/cities?eagerload=%b", eagerload));
